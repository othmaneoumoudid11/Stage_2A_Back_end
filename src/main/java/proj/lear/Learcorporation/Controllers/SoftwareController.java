...
public class SoftwareController {
	...
	public ResponseEntity<Software> AjouterSoftware(@ApiParam(value = "Objet Software",required = true) @RequestBody Software software){
	...
	public ResponseEntity<?> SupprimerSoftware(@ApiParam(value = "ID software",required = true) @PathVariable("id") Long id){
	...
	public ResponseEntity<Software> ModifierSoftware(@ApiParam(value = "Objet software",required = true) @RequestBody Software software){
	...
	public ResponseEntity<Software> ChercherSoftware(@ApiParam(value = "ID software",required = true) @PathVariable("id") Long id){
	...
	public ResponseEntity<Approv_Soft> AprovSoftware(@ApiParam(value = "Objet aprov software",required = true) @RequestBody Approv_Soft aprsoft){
